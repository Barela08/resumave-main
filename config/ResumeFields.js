export default {
    contact: {
        ...
        name: 'Contact',
        fields: [
            { name: 'name', label: 'Full Name', placeholder: 'Nilesh Barela', required: true },
            ...
            { name: 'linkedin', label: 'Linked', placeholder: 'linkedin.com/in/nileshbarela' },
            { name: 'github', label: 'Github', placeholder: 'github.com/nileshbarela' },
            { name: 'blogs', label: 'Blogs', placeholder: 'github.com/nileshbarela' },
            { name: 'twitter', label: 'Twitter', placeholder: 'github.com/nileshbarela' },
            { name: 'portfolio', label: 'Portfolio', placeholder: 'nileshbarela.com' },
        ],
    },
    summary: {
        name: 'Summary',
